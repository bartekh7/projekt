<?php
	...
	else
	{
		...
		print_r($_POST); //wyświetlanie zawartości tablicy POST
		...
		$add = "INSERT INTO przepisy (nazwa, przepis, userid, kategoriaid, poziomid, czas) VALUES ('$nazwa', '$sposob', '$id','$kategoria','$poziom',$czas')";
